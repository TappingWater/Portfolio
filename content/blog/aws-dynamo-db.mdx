---
type: Blog
title: A Beginner's Dive into Dynamo Db Part 1
date: 2023-08-02
...
technologies:
    ...
    - DynamoDb
summary:
    Diving into NoSQL databases from the perspective of a developer familiar
    with SQL
---
...
for this purpose. This is my documentation on what I learned during my journey
to hosting a production ready database.
